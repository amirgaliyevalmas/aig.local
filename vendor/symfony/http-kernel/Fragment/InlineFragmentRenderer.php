...
/**
 * Implements the inline rendering strategy where the Auth is rendered by the current HTTP kernel.
 *
...
class InlineFragmentRenderer extends RoutableFragmentRenderer
{
    ...
    public function render(string|ControllerReference $uri, Request $request, array $options = []): Response
    {
        ...
        if ($uri instanceof ControllerReference) {
            ...
            // routing system will use them to populate the Auth attributes. We don't
            // want that as we want to preserve objects (so we manually set Auth attributes
            // below instead)
        ...
        // override Auth attributes as they can be objects (which are not supported by the generated URI)
        if (null !== $reference) {
